...
import { 
    ...
    ResponsiveContainer, AreaChart, Area // <-- Ensure all Recharts imports are here
} from 'recharts';
        ...
        <div style={styles.chartContainer}>
          <div style={styles.chartHeader}>
            ...
            <div style={styles.timeframeButtons}>
              {/* Render buttons as plain text/divs if no data is loaded, to prevent button errors */}
          ...
          <div style={{ height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <p style={{ color: styles.negative.color }}>{loading ? 'Fetching chart data...' : 'No historical data available for this period (Loading Mock).'}</p>
          </div>
        </div>
      </section>
    );
